...
const HomeUI = () => {
  ...
  const handleConnect = (deviceName) => {
    Alert.alert('Connection', `Connecting to ${deviceName}...`);
  };
                ...
                <View style={styles.patternBarContainer}>
                  <View
                    style={[
                      styles.patternBar,
                      {
                        height: `${pattern.count * 15}%`,
                        backgroundColor: pattern.count > 2 ? '#e53e3e' : '#f6ad55'
                      }
                    ]}
                  />
                </View>
...
const styles = StyleSheet.create({
  ...
  logoutText: { color: '#1976D2', fontWeight: '500' },
  ...
  sectionTitle: { fontSize: 16, fontWeight: '600', color: '#2d3748', marginLeft: 8 },
  seeAllButton: { marginLeft: 'auto' },
  seeAllText: { color: '#1976D2', fontSize: 14 },
  statusOverview: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 },
  statusCard: {
  ...
  statusCardValue: { fontSize: 20, fontWeight: 'bold', color: '#2b6cb0', marginBottom: 4 },
  statusCardLabel: { fontSize: 12, color: '#4a5568', textAlign: 'center' },
  table: {
    borderWidth: 1,
    borderColor: '#e2e8f0',
    borderRadius: 8,
  ...
  tableCell: { fontSize: 14, color: '#4a5568' },
  tableCellContainer: { flexDirection: 'row', alignItems: 'center' },
  statusCell: { fontWeight: '600' },
  connected: { color: '#38a169' },
  notConnected: { color: '#e53e3e' },
  connectButton: {
    marginLeft: 10,
    paddingVertical: 4,
    paddingHorizontal: 8,
  ...
  connectButtonText: { color: '#fff', fontSize: 12 },
  ...
  alertDetails: { flex: 1 },
  alertType: { fontSize: 14, fontWeight: '500', color: '#2d3748', marginBottom: 2 },
  alertTime: { fontSize: 12, color: '#718096' },
  patternContainer: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    marginTop: 16,
  ...
  patternDay: { alignItems: 'center', width: '12%' },
  patternDayLabel: { fontSize: 12, color: '#718096', marginBottom: 8 },
  patternBarContainer: { height: '80%', justifyContent: 'flex-end', width: '100%' },
  patternBar: { width: '100%', borderRadius: 4 },
  patternCount: { fontSize: 12, color: '#4a5568', marginTop: 4 },
  bottomNav: {
    flexDirection: 'row',
